...
The Dapp is a workflow tracking system designed for efficient project management, focusing on issue resolution and development. It enables users to add and manage project issues, assign them to specific members, track project phases, and filter issues based on their status. Additionally, the Dapp allows users to add and manage team members, updating their profiles with relevant information such as experience and skills. The system supports various operations like changing status, deleting issues or members, retrieving detailed information about issues, members, and project progress. With comprehensive functionalities, the Dapp facilitates collaborative planning and progress tracking in a structured and organized manner.
